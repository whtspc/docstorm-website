 ...
 */
// Scenario base path
const scenarioAssetPath = 'DocStorm-Interactive-Webpage-Component/DocStorm-Interactive-Webpage-Component/assets/docs/';
...
const assetBasePath = 'DocStorm-Interactive-Webpage-Component/DocStorm-Interactive-Webpage-Component/assets/docs/';
...
export const demoFiles = [
  {
    ...
    label: 'Business Card',
    previewSrc: assetBasePath + 'businesscard.svg',
    record: leadData,
    processingSteps: [
      'Analyzing image...',
  ...
  },
  {
    ...
    label: 'Invoice',
    previewSrc: assetBasePath + 'invoice.svg',
    record: invoiceData,
    processingSteps: [
      'Reading PDF...',
      'Extracting line items...',
  ...
  },
  {
    ...
    previewSrc: assetBasePath + 'order.svg',
    record: orderData,
    processingSteps: [
      'Processing document...',
      'Extracting order details...',
